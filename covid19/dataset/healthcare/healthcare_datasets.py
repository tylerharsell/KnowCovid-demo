...
"""
HEALTHCARE_DATASETS_MAP = [
    ['IHME- Global Burden of Disease (GBD) series',     'ihme',            False,   ''],
    ['Global Health Estimates (GHE)',                   'ihme',            False,   ''],
    ['Global Burden of Disease',                        'ihme',            False,   ''],
    ['Whole Exome Sequencing',                          'ghe',             False,   ''],
    ['Global Health Observatory',                       'gbd',             False,   ''],
    ['Nature Study',                                    'ns',              False,   ''],
    ['GIDEON',                                          'gideon',          False,   ''],
    ['HealthMap',                                       'healthmap',       False,   ''],
	['WHO Mortality Database',                          'who',             False,   ''],
	['ProMED',                                          'promed',          False,   ''],
