...
def collector():
    ...
    #base_url = 'https://academic.oup.com/jid/search-results?q=covid19+or+coronavirus&sort=Date+%e2%80%93+Newest+First&allJournals=1&f_ContentType=Journal+Article&fl_SiteID=5309&page=%d'
    papers_info = {}
    papers_original = {}
    ...
    for item in range(1, 11):
        ...
        url =  'https://academic.oup.com/jid/search-results?q=covid19+or+coronavirus&sort=Date+%e2%80%93+Newest+First&allJournals=1&f_ContentType=Journal+Article&fl_SiteID=5309&page='+str(item)
        sys.stdout.flush()
        try:
            driver.get(url)
    ...
    with open(JID_VIROL_INFO_PATH, 'w') as fp:
        json.dump(papers_info, fp)

    with open(JID_VIROL_ORI_PATH, 'w') as fp:
